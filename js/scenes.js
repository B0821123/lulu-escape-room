...
export const SCENES = {
  ...
  m1: {
    ...
    intro: ["大典的銅門深鎖。門楣上一行扭曲的符文，靜靜等著被讀懂。"],
    puzzle: { name: "cipherWheel", params: { shift: 5 } },
    reward: PALACE.m1,
    hints: [
      "扭曲的符文，其實是英文字母被『整齊地位移』後的結果——一種古典密碼。",
      "位移量是個位數；耐心一格一格轉動星環，留意何時冒出像樣的英文。",
      `當符文對齊時，咒語會讀作：${config.spell}`,
    ],
  },
  m2: {
